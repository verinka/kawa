...
export default () => (
  <section className="section" style={{ color: "#000" }}>
    ...
    <p>
      Wrevery, LLC is committed to ensuring that the app is as useful and efficient as possible. For that reason, we
    ...
    <p>
      The кawa app stores and processes personal data that you have provided to us, in order to provide our Service.
      ...
      programs, compromise your phone’s security features and it could mean that the кawa app won’t work properly or at
      all.
    </p>
    <div>
    ...
    <p>
      You should be aware that there are certain things that Wrevery, LLC will not take responsibility for. Certain
      functions of the app will require the app to have an active internet connection. The connection can be Wi-Fi, or
      provided by your mobile network provider, but Wrevery, LLC cannot take responsibility for the app not working at
    ...
    <p>
      Along the same lines, Wrevery, LLC cannot always take responsibility for the way you use the app i.e. You need to
      make sure that your device stays charged – if it runs out of battery and you can’t turn it on to avail the
      Service, Wrevery, LLC cannot accept responsibility.
    </p>
    <p>
      With respect to Wrevery, LLC’s responsibility for your use of the app, when you’re using the app, it’s important
      to bear in mind that although we endeavour to ensure that it is updated and correct at all times, we do rely on
      third parties to provide information to us so that we can make it available to you. Wrevery, LLC accepts no
    ...
    <p>
      ...
      need to download the updates if you want to keep using the app. Wrevery, LLC does not promise that it will always
